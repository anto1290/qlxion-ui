    ...
    <Layout>
      <div className="mx-auto max-w-3xl space-y-8 p-6">
        <div>
          ...
          <p className="mt-2 text-lg text-muted-foreground">Komponen pesan dengan avatar dan metadata waktu.</p>
        </div>

        <section>
          <h2 className="mb-3 text-xl font-semibold">Installation</h2>
          <pre className="overflow-x-auto rounded-md bg-muted p-4 text-sm"><code>npx qlxion-ui add message</code></pre>
        </section>

        <section>
          <h2 className="mb-3 text-xl font-semibold">Usage</h2>
          <pre className="overflow-x-auto rounded-md bg-muted p-4 text-sm"><code>{`import { Message } from "@/components/ui/message";`}</code></pre>
        </section>
        ...
        <section>
          ...
          <pre className="overflow-x-auto rounded-md bg-muted p-4 text-sm"><code>{`<Message author="Alice" timestamp="12:30 PM" side="left">Hello!</Message>`}</code></pre>
        </section>

        <section>
          <h2 className="mb-3 text-xl font-semibold">API</h2>
          <h3 className="mb-2 text-base font-medium">Sub-components</h3>
          <ul className="list-disc pl-6 space-y-1 text-sm"><li><code className="font-mono text-xs bg-muted px-1 py-0.5 rounded">Message</code></li></ul>
          <h3 className="mb-4 mt-4 text-base font-medium">Props</h3>
          <div className="overflow-x-auto"><table className="w-full border-collapse text-sm"><thead><tr className="bg-muted"><th className="border border-border px-3 py-2 text-left font-semibold">Prop</th><th className="border border-border px-3 py-2 text-left font-semibold">Type</th><th className="border border-border px-3 py-2 text-left font-semibold">Default</th><th className="border border-border px-3 py-2 text-left font-semibold">Description</th></tr></thead><tbody><tr><td className="border border-border px-3 py-2 font-mono text-sm">avatar</td><td className="border border-border px-3 py-2 text-sm text-muted-foreground">ReactNode</td><td className="border border-border px-3 py-2 text-sm">-</td><td className="border border-border px-3 py-2 text-sm">Avatar pengirim.</td></tr>
<tr><td className="border border-border px-3 py-2 font-mono text-sm">author</td><td className="border border-border px-3 py-2 text-sm text-muted-foreground">string</td><td className="border border-border px-3 py-2 text-sm">-</td><td className="border border-border px-3 py-2 text-sm">Nama pengirim.</td></tr>
<tr><td className="border border-border px-3 py-2 font-mono text-sm">timestamp</td><td className="border border-border px-3 py-2 text-sm text-muted-foreground">string</td><td className="border border-border px-3 py-2 text-sm">-</td><td className="border border-border px-3 py-2 text-sm">Waktu pesan.</td></tr>
<tr><td className="border border-border px-3 py-2 font-mono text-sm">side</td><td className="border border-border px-3 py-2 text-sm text-muted-foreground">"left" | "right"</td><td className="border border-border px-3 py-2 text-sm">"left"</td><td className="border border-border px-3 py-2 text-sm">Posisi pesan.</td></tr></tbody></table></div>
        </section>

        <section>
          <h2 className="mb-3 text-xl font-semibold">Accessibility</h2>
          <ul className="list-disc pl-6 space-y-1 text-sm"><li>Gunakan landmark atau list untuk grup pesan</li></ul>
        </section>
