  ...
  return (
    <Layout>
      <main className="prose mx-auto max-w-3xl p-6">
        <h1>Aspect-ratio</h1>
        <h2>Description</h2>
        <p>Container untuk mempertahankan rasio aspek gambar atau media</p>

        <h2>Installation</h2>
        <pre><code>npx qlxion-ui add aspect-ratio</code></pre>

        <h2>Usage</h2>
        <pre><code>{'<Aspect-ratio />'}</code></pre>
...
npx qlxion-ui add aspect-ratio</code></pre>
      </main>
    </Layout>
  );
}
