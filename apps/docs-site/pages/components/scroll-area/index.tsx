  ...
  return (
    <Layout>
      <div className="mx-auto max-w-3xl space-y-8 p-6">
        <div>
          <h1 className="text-3xl font-bold">ScrollArea</h1>
          <p className="mt-2 text-lg text-muted-foreground">Area scroll kustom.</p>
        </div>

        <section>
          <h2 className="mb-3 text-xl font-semibold">Installation</h2>
          <pre className="overflow-x-auto rounded-md bg-muted p-4 text-sm"><code>npx qlxion-ui add scroll-area</code></pre>
        </section>

        <section>
          <h2 className="mb-3 text-xl font-semibold">Usage</h2>
          <pre className="overflow-x-auto rounded-md bg-muted p-4 text-sm"><code>{`import { ScrollArea } from "@/components/ui/scroll-area";`}</code></pre>
        </section>
        ...
        <section>
          ...
          <pre className="overflow-x-auto rounded-md bg-muted p-4 text-sm"><code>{`<ScrollArea className="h-64">{items.map((item) => <div key={item.id}>{item.label}</div>)}</ScrollArea>`}</code></pre>
        </section>

        <section>
          <h2 className="mb-3 text-xl font-semibold">API</h2>
          <h3 className="mb-2 text-base font-medium">Sub-components</h3>
          <ul className="list-disc pl-6 space-y-1 text-sm"><li><code className="font-mono text-xs bg-muted px-1 py-0.5 rounded">ScrollArea</code></li></ul>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1 text-sm"><li>Konten harus tetap keyboard-navigable</li></ul>
        </section>
