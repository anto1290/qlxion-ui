    ...
    <Layout>
      <div className="mx-auto max-w-3xl space-y-8 p-6">
        <div>
          ...
          <p className="mt-2 text-lg text-muted-foreground">Placeholder loading dengan animasi pulse.</p>
        </div>

        <section>
          <h2 className="mb-3 text-xl font-semibold">Installation</h2>
          <pre className="overflow-x-auto rounded-md bg-muted p-4 text-sm"><code>npx qlxion-ui add skeleton</code></pre>
        </section>

        <section>
          <h2 className="mb-3 text-xl font-semibold">Usage</h2>
          <pre className="overflow-x-auto rounded-md bg-muted p-4 text-sm"><code>{`import { Skeleton } from "@/components/ui/skeleton";`}</code></pre>
        </section>
