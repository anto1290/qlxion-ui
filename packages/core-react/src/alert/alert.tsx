  ...
  "relative w-full rounded-lg border p-4 text-sm [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground",
  {
    variants: {
      variant: {
        ...
        success: "border-green-500/50 text-green-700 dark:text-green-400 bg-green-500/10 [&>svg]:text-green-500",
        warning: "border-amber-500/50 text-amber-700 dark:text-amber-400 bg-amber-500/10 [&>svg]:text-amber-500",
      },
    },
    defaultVariants: {
      variant: "default",
